...
def process_data():
    print("Initializing Data Processing Pipeline (Fast Version)...")
    ...
    print("Loading Trip Data (Streaming Chunks - Fast Mode)...")
    chunk_size = 100000
    try:
    ...
    for i, chunk in enumerate(reader):
        ...
        # Write incrementally to CSV only (much faster)
    ...
    # Now convert CSV to Parquet once at the end
